...
(function() {
  ...
  module.exports = function(BasePlugin) {
    var ServicesPlugin;
    return ServicesPlugin = (function(superClass) {
      extend(ServicesPlugin, superClass);
      ...
      ServicesPlugin.prototype.templateData = {
        ...
        getServices: function() {
          var ref, services;
          services = ((ref = this.site) != null ? ref.services : void 0) || {};
          return services;
        },
        ...
        getSocialButtons: function(services) {
          var button, buttonAdjusted, buttons, fn, fnName, i, len, result;
          if (services == null) {
            services = this.getServices();
          }
        ...
        getServiceBadges: function(services) {
          var button, buttonAdjusted, buttons, fn, i, len, result;
          if (services == null) {
            services = this.getServices();
          }
        ...
        getFacebookLikeButton: function(services) {
          var facebookApplicationId, pageUrl, ref, ref1;
          if (services == null) {
            services = this.getServices();
          }
          facebookApplicationId = (ref = (ref1 = services.facebookLikeButton) != null ? ref1.applicationId : void 0) != null ? ref : '266367676718271';
        ...
        getFacebookFollowButton: function(services) {
          var facebookApplicationId, facebookUsername, ref, ref1, ref2;
          if (services == null) {
            services = this.getServices();
          }
          facebookApplicationId = (ref = (ref1 = services.facebookFollowButton) != null ? ref1.applicationId : void 0) != null ? ref : '266367676718271';
          facebookUsername = (ref2 = services.facebookFollowButton) != null ? ref2.username : void 0;
        ...
        getGithubStarButton: function(services) {
          var githubRepo, githubUsername, parts, ref;
          if (services == null) {
            services = this.getServices();
          }
          parts = (ref = services.githubStarButton) != null ? ref.split('/') : void 0;
        ...
        getQuoraFollowButton: function(services) {
          var quoraCode, quoraRealname, quoraUsername, ref;
          if (services == null) {
            services = this.getServices();
          }
          quoraUsername = (ref = services.quoraFollowButton) != null ? ref : '';
          if (!quoraUsername) {
            return '';
          }
        ...
        getDisqus: function(services) {
          ...
          disqusDeveloper = indexOf.call(this.getEnvironments(), 'production') >= 0 ? '0' : '1';
          pageUrl = this.getPageUrl();
          disqusIdentifier = this.document.slug;
          disqusTitle = (this.document.title || this.document.name).replace('\'', '\\\'');
      ...
      ServicesPlugin.prototype.populateCollections = function(opts) {
        var config, docpad, i, len, scripts, scriptsBlock, serviceScript, serviceScriptContent, serviceScripts, templateData;
        docpad = this.docpad;
        config = this.config;
        ...
        for (i = 0, len = serviceScripts.length; i < len; i++) {
          serviceScript = serviceScripts[i];
